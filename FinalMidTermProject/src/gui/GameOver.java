...
public class GameOver {
	...
	private void initialize() {
		...
		powerLeftTxt.setForeground(Color.BLACK);
		...
		correctAnswersTxt.setForeground(Color.BLACK);
		...
		correctLettersTxt.setForeground(Color.BLACK);
		...
		playerLevelTxt.setBounds(200, 130, 140, 25);
		playerLevelTxt.setForeground(Color.BLACK);
		...
		playerLevel.setBounds(340, 130, 140, 25);
		...
		lblNewLabel.setFont(new Font("BankGothic Lt BT", Font.ITALIC, 50));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(200, 265, 286, 63);
		frame.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(GameOver.class.getResource("/images/GameOverPic.jpg")));
